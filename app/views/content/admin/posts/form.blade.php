...
<h1 style="margin-left:20px"><i class='fa fa-user'></i> {{Request::segment(3)=='create'?'Создать объявление':'Редактировать объявление'}}</h1>
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class='col-md-12  form-group'>
                    ...
                    <input type="submit" class="btn btn-primary account_post_save_btn" value="Сохранить">
                </div>
            </div>                             
        </div>                             
    {{ Form::close() }}
