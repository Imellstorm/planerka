            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::segment(2)=='roles'?'active':'' }}">{{ link_to('admin/roles','Типы пользователей') }}</li>  
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Блог <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li class="{{ Request::segment(3)=='categories'?'active':'' }}">{{ link_to('admin/blog/categories','Категории') }}</li>
                    <li class="{{ Request::segment(3)=='subcategories'?'active':'' }}">{{ link_to('admin/blog/subcategories','Подкатегории') }}</li>  
                  </ul>
                </li>
